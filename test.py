...
parse.add_argument('-input_len', type=int, default=12)
parse.add_argument('-gis_num', type=int, default=47)
...
def train_epoch(data_type='train'):
    ...
    #             loss.backward()
    #             optimizer.step()
    if (opt.input_len > 0) & (opt.gis_num > 0):
...
if __name__ == '__main__':
    ...
    # get data channels
    channels = [opt.input_len * opt.nb_flow,
                opt.gis_num * opt.nb_flow]
